...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case 0: {
            ...
            [cell.imageView sd_setImageWithURL: [NSURL URLWithString: @"https://cdn1.iconfinder.com/data/icons/user-pictures/101/malecostume-512.png"] completed: ^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                if (image != nil) {
        ...
        case 1: {
            ...
            if (cell.imageView.image == nil)
            [cell.imageView sd_setImageWithURL: [NSURL URLWithString: @"https://cdn1.iconfinder.com/data/icons/user-pictures/100/female1-512.png"] completed: ^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                if (image != nil) {
                    [self.tableView reloadData];
                }
            } ];
